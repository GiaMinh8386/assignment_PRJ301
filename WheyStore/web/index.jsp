            ...
            <div class="sidebar">
                ...
                <div class="sidebar-content">
                    ...
                    <div class="category-section">
                        ...
                        %>
                        <a href="MainController?action=home" class="category-link <%= (currentAction == null || "home".equals(currentAction)) ? "active" : "" %>">
                            <i class="fas fa-th-large"></i>Tất cả sản phẩm
                        </a>
                        <a href="MainController?action=filterByCategory&categoryId=1" class="category-link <%= "1".equals(currentCategoryId) ? "active" : "" %>">
                            <i class="fas fa-dumbbell"></i>Whey Protein
                        </a>
                        <a href="MainController?action=filterByCategory&categoryId=2" class="category-link <%= "2".equals(currentCategoryId) ? "active" : "" %>">
                            <i class="fas fa-muscle"></i>Creatine
                        </a>
                        <a href="MainController?action=filterByCategory&categoryId=3" class="category-link <%= "3".equals(currentCategoryId) ? "active" : "" %>">
                            <i class="fas fa-pills"></i>Vitamin & Khoáng Chất
                        </a>
                        <a href="MainController?action=filterByCategory&categoryId=4" class="category-link <%= "4".equals(currentCategoryId) ? "active" : "" %>">
                            <i class="fas fa-fire"></i>Hỗ Trợ Giảm Mỡ
                        </a>
                        <a href="MainController?action=filterByCategory&categoryId=5" class="category-link <%= "5".equals(currentCategoryId) ? "active" : "" %>">
                            <i class="fas fa-heartbeat"></i>Sinh lý & Nội tiết tố
                        </a>
                    </div>
